...
async function main() {
  try {
    ...
    // Generate a treasury keypair for the protocol
    const treasuryKeypair = Keypair.generate();
    console.log('- Treasury Address:', treasuryKeypair.publicKey.toString());
    console.log('- Treasury Private Key:', JSON.stringify(Array.from(treasuryKeypair.secretKey)));
    ...
    */
    ...
    console.log('Now you can initialize the protocol with:');
    console.log('node initialize-protocol.js');
